...
import com.hd.entity.system.User;
import com.hd.service.gh.GoodsManager;
import com.hd.service.system.appuser.AppuserManager;
import com.hd.service.system.buttonrights.ButtonrightsManager;
import com.hd.service.system.fhbutton.FhbuttonManager;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("loginname", "").replaceAll("password", "").split(",yt,");
	...
	public ModelAndView defaultPage(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData> memberList =goodsService.goodsList(page);	//列出用户列表
		//mv.setViewName("system/index/default");
