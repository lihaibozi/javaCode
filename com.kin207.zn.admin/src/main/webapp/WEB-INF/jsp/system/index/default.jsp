...
<script type="text/javascript" src="static/js/enum.js"></script>
<!--查看图片插件 -->
<!-- jsp文件头和头部 -->
							...
							<c:when test="${not empty memberList}">
								...
								<c:forEach items="${memberList}" var="var" varStatus="vs">
									<tr>
										...
										<td>
											<a href="javascript:;" data-value="${var.username}" data-img="${var.headImg}" data-tel="${var.tel}" data-email="${var.email}" onclick="memberOrder(this);">
										...
										<span class="label label-large label-grey arrowed-in-right arrowed-in"><i class="ace-icon fa fa-lock" title="无权限"></i></span>
											...
											&nbsp;
											<c:if test="${QX.del == 1 }">
											<a style="cursor:pointer;" class="red" onclick="del('${var.id}','${var.headImg}');" title="删除">
