...
<body class="no-skin">
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
					<!-- 检索  -->
					<form action="type/typeList.do" method="post" name="Form" id="Form">
	...
	<script type="text/javascript">
		...
		function del(Id){
			...
			if(confirm("确定要删除?")){ 
				top.jzts();
				var url = "<%=basePath%>type/delete.do?id="+Id;
		...
		function edit(id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>type/goEdit.do?id='+id;
			 diag.Width = 400;
			 diag.Height = 350;
			 diag.CancelEvent = function(){ //关闭事件
			...
			if(confirm(msg)){ 
					...
					if(str==''){
						...
						if(msg == '确定要删除选中的数据吗?'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>type/deleteAll.do',
						    	data: {DATA_IDS:str},
								dataType:'json',
