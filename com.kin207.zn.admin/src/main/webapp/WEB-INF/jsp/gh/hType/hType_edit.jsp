		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="hType/${msg}.do" name="typeForm" id="typeForm"  method="post" enctype="multipart/form-data">
							<input type="hidden" name="id" id="id" value="${pd.id }"/>
							<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
								<tr>
									<td style="width:79px;text-align: right;padding-top: 13px;">维修类别</td>
									<td><input type="text" name="type" id="type" value="${pd.type }" placeholder="这里输入维修类别" title="维修类别" style="width:98%;" onblur="hasN('${pd.depName }')"/></td>
								</tr>
								<tr>
...
<script type="text/javascript">
	...
	//保存
	function save(){
		if(checkNull("type","请输入维修类别","type")){
			return ;
		};
		var str = '';
