package com.hd.controller.system.user;
...
import com.hd.util.FileDownload;
import com.hd.util.FileUpload;
import com.hd.util.GetPinyin;
import com.hd.util.Jurisdiction;
import com.hd.util.ObjectExcelRead;
import com.hd.util.ObjectExcelView;
import com.hd.util.PageData;
import com.hd.util.PathUtil;
...
public class UserController extends BaseController {
	...
	public void downFile(HttpServletResponse response,
		...
		FileDownload.fileDownload(response, this.getRequest().getSession().getServletContext().getRealPath(AppConst.EMPLOYEE_PHOTO_PATH)+"\\"+fileName,
				fileName);
	}
	...
	public boolean delFile(
			@RequestParam(value="fileName",required=true) String fileName)throws Exception{
		return FileDownload.deleteFile(this.getRequest().getSession().getServletContext().getRealPath(AppConst.EMPLOYEE_PHOTO_PATH)+"\\"+fileName);
	}
