package com.hd.controller.system.menu;
...
import com.hd.util.RightsHelper;
/** 
...
public class MenuController extends BaseController {
	...
	public ModelAndView add(Menu menu, RedirectAttributes attr)throws Exception{
		...
		try{
			...
			attr.addAttribute("MSG", "change");	
			attr.addAttribute("MENU_ID", menu.getPARENT_ID());
		} catch(Exception e){
			logger.error(e.toString(), e);
			mv.addObject("msg","failed");
		}
		//mv.setViewName("redirect:?MSG='change'&MENU_ID="+menu.getPARENT_ID());
		mv.setViewName("redirect:/menu.do");//保存成功跳转到列表页面
		//mv.setViewName("redirect:listAllMenu.do"); //保存成功跳转到列表页面
		return mv;
	}
	...
	public ModelAndView edit(Menu menu, RedirectAttributes attr)throws Exception{
