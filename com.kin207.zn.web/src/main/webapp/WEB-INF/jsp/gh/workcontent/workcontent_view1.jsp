					...
					<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
						<thead>
							<tr>
								...
								<th class="center" >患者年龄</th>
								<th class="center" >患者身份证号码</th>
								<th class="center" >患者联系方式</th>
								<th class="center" >诊断/手术结果</th>
								<th class="center" >诊断/手术日期</th>
								<th class="center" >手术级别</th>
							...
							<c:when test="${not empty workContents}">
								...
								<c:forEach items="${workContents}" var="var" varStatus="vs">
									<tr>
										...
										<td class="center">${var.patientSex}</td>
										<td class="center">${var.patientAge}</td>
										<td class="center">${var.patientCardNo}</td>
										<td class="center">${var.patientCellPhone}</td>
										<td class="center">${var.medicalResult}</td>
										<td class="center"><fmt:formatDate value="${var.medicalDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
										<td class="center">${var.operationLevel}</td>
										<td>
										...
										<%-- <a id="loadFile" style="cursor:pointer" onclick="loadFile('${var.fileName}');return false;">${var.fileName}</a> --%>
										</c:if>
										</td>
