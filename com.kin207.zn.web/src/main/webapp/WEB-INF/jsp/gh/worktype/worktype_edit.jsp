		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="worktype/${msg}.do" name="worktypeForm" id="worktypeForm"  method="post" enctype="multipart/form-data">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tr>
									<td style="width:130px;text-align: right;padding-top: 13px;">工作类名<label style="color:#ff0000">*</label></td>
									<td><input type="text" name="workName" id="workName" value="${pd.workName }" placeholder="这里输入工作类名" title="工作类名" style="width:98%;" /></td>
								</tr>
								<tr>
...
<script type="text/javascript">
	...
	function save(){
		...
		if(checkNull("workName","请输入工作类名","workName")){
			return ;
		};
