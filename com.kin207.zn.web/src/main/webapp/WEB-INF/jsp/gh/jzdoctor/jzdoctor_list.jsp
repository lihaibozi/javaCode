...
<body class="no-skin">
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
					<!-- 检索  -->
					<form action="jzdoctor/jzdoctorList.do" method="post" name="Form" id="Form">
					...
					<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
						...
						<!-- 开始循环 -->	
						<c:choose>
							<c:when test="${not empty jzdoctorList}">
								<c:if test="${QX.cha == 1 }">
								<c:forEach items="${jzdoctorList}" var="var" varStatus="vs">
									<tr>
	...
	<script type="text/javascript">
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>jzdoctor/goEdit.do?id='+Id;
			 diag.Width = 640;
			 diag.Height = 480;
			 diag.CancelEvent = function(){ //关闭事件
