...
<body class="no-skin">
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
					<!-- 检索  -->
					<form action="hDepartment/hDepartment.do" method="post" name="Form" id="Form">
					...
					<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
						<thead>
							<tr>
								...
								<th class="center" >科室负责人</th>
								<th class="center" >负责人联系电话</th>
								<th class="center" >所属医院</th>
								<th class="center" >是否开展工作科室</th>
	...
	<script type="text/javascript">
		...
		//新增
		function add(){
			 addOrEdit('<%=basePath%>hDepartment/goAdd.do','新增');
		}
		...
		function del(Id,Image){
			...
			if(confirm("确定要删除?")){ 
				top.jzts();
				var url = "<%=basePath%>hDepartment/delete.do?id="+Id+"&Image="+Image;
			...
			if(confirm(msg)){ 
					...
					if(str==''){
						...
						if(msg == '确定要删除选中的数据吗?'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>hDepartment/deleteAll.do',
						    	data: {DATA_IDS:str},
								dataType:'json',
		...
		//修改
		function edit(Id){
			addOrEdit('<%=basePath%>hDepartment/goEdit.do?id='+Id,'编辑');
		}
