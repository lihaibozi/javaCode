				...
				<div class="row">
					...
					<form action="timingbackup/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">任务类别:</td>
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="jobType" id="jobType" data-placeholder="请选择" style="vertical-align:top;width: 200px;">
									<option value="1">短信提醒</option>
									<option value="2">数据库备份</option>
								</td>
							</tr>
							<tr>
