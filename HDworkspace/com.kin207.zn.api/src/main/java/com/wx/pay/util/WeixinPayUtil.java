...
import com.wx.pay.model.WeixinInfo;
...
public class WeixinPayUtil {
	...
	public static String getPayNo(String url, String xmlParam) {
		...
		client.getParams().setParameter(ClientPNames.ALLOW_CIRCULAR_REDIRECTS,
				true);
		System.out.println("getPayNo url :"+url);
	 ...
	 * @return
	 */
	public static String generateCodeUrl(WeixinInfo weixinInfoDTO){
		String codeUrl = "";
	 ...
	 * @return
	 */
	public static String buildWeixinXml(WeixinInfo weixinInfoDTO){
