...
public class SqlMapper {
     ...
     * @return
     */
    public int insert(String sql, String idColumn) {
        String msId = msUtils.insert(sql, idColumn);
     ...
     * @return
     */
    public int insert(String sql, String idColumn, Object value) {
        Class<?> parameterType = value != null ? value.getClass() : null;
        String msId = msUtils.insertDynamic(sql, idColumn, parameterType);
        
        int result = sqlSession.insert(msId, value);
        return result;
    }
    ...
    private class MSUtils {
         ...
         */
        @SuppressWarnings("serial")
		private void newInsertMappedStatement(String msId, SqlSource sqlSource, String idColumn) {
        ...
        private String insert(String sql, String idColumn) {
            String msId = newMsId(sql, SqlCommandType.INSERT);
            if (hasMappedStatement(msId)) {
                return msId;
            }
            StaticSqlSource sqlSource = new StaticSqlSource(configuration, sql);
            newInsertMappedStatement(msId, sqlSource, idColumn);
            return msId;
        }

        private String insertDynamic(String sql, String idColumn, Class<?> parameterType) {
