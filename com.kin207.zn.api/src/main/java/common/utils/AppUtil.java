...
public class AppUtil  {
	 ...
	 * @return
	 */
	public static File MultipartFilToFile(MultipartFile file){
	 ...
	 * @return
	 */
	public static String getPhotoType(MultipartFile file){
	 ...
	 * @return
	 */
	public static String getPhotoTypeByName(String file){
		if(file!=null &&!"".equals(file)){
		String photoType= file.substring(file.indexOf("."),file.length());
		return photoType;
		}else{
			return "";
		}
